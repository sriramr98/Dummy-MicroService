...
const (
	AuthService_GetUserInfo_FullMethodName = "/main.AuthService/GetUserInfo"
)
...
func (c *authServiceClient) GetUserInfo(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserInfo, error) {
...
func (UnimplementedAuthServiceServer) GetUserInfo(context.Context, *UserRequest) (*UserInfo, error) {
